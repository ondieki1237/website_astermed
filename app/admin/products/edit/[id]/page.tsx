...
export default function EditProductPage() {
  ...
  async function fetchProduct() {
    try {
      ...
      // Backend returns { product, similarProducts, analytics }
      ...
      // Convert specifications to text format
      if (product.specifications) {
        if (Array.isArray(product.specifications)) {
          ...
          // If specifications is an object, convert to text
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const data = await res.json()
      if (!res.ok) throw new Error(data.message || (data && data.errors ? JSON.stringify(data.errors) : 'Failed to update product'))
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8 flex items-center justify-center">
        <div className="text-center">
          <div className="inline-block w-16 h-16 border-4 border-[#1f2a7c]/20 border-t-[#1f2a7c] rounded-full animate-spin"></div>
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer">
                    {preview ? (
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-[#1f2a7c] font-medium">Upload Image</p>
